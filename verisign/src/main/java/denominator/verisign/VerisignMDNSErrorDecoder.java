    ...
    try {
      ...
      SOAPFault soapFault =
          MessageFactory.newInstance(SOAPConstants.SOAP_1_2_PROTOCOL)
              .createMessage(null, response.body().asInputStream()).getSOAPBody().getFault();
          ...
          if ("dnsaWSRes".equals(detailEntry.getLocalName())) {
            ...
            while (childElementsIter.hasNext()) {
              ...
              if ("reason".equals(soapElement.getLocalName())) {
                return new VerisignMDNSException(soapElement.getAttribute("description"),
                    soapElement.getAttribute("code"));
              }
