...
import static denominator.verisign.VerisignMDNSTarget.SOAP_TEMPLATE;
...
public class MockVerisignMDNSServer extends VerisignMDNSProvider implements TestRule {
  ...
  MockVerisignMDNSServer credentials(String username, String password) {
  ...
  @dagger.Module(injects = DNSApiManager.class, complete = false,
      includes = VerisignMDNSProvider.Module.class)
  ...
  static final String FAULT_TEMPLATE = 
      ...
      + "              <ns4:callSuccess>false</ns4:callSuccess>"
      + "              <ns4:reason code=\"%s\" description=\"%s\"/>"
      + "       </ns4:dnsaWSRes>"
      + "   </ns3:Detail>"
      + "</ns3:Fault>";
}
